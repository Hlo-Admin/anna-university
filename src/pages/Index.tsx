...
import { sendEmail, createSubmissionConfirmationEmail } from "@/utils/emailService";
...
const Index = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `Form submitted successfully! Your submission ID is ${submissionId}. A confirmation email has been sent to your email address. Your document has been uploaded to Google Drive.`,
      });
          ...
          <Card className="w-full max-w-3xl shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-t-lg text-center">
              ...
              <CardDescription className="text-blue-100">
                Please fill out the form below to submit your paper. Documents will be stored securely in Google Drive.
              </CardDescription>
            </CardHeader>
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400">DOC, DOCX up to 10MB (will be stored in Google Drive)</p>
                    </div>
                ...
                <div className="flex gap-4">
                  ...
                  >
                    {isSubmitting ? "Uploading to Google Drive..." : "Submit"}
                  </Button>
                </div>
              </form>
            </CardContent>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              Documents are securely stored in Google Drive for safe keeping.
            </p>
            <Button
              onClick={() => setShowForm(true)}
